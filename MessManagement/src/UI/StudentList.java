...
public class StudentList extends javax.swing.JFrame implements StudentListener {
    ...
    public void getStudents() {
        ArrayList students = DBManager.getStudentList();
        DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
        for(int i=0;i<students.size();i++){
          Student s = (Student) students.get(i);
          model.addRow(new Object[]{s.getHostelRollNo(),s.getName(),s.getCourse()}); 
        }
    }
    private void initTable() {
        DBManager.fetchStudentList(this);
    }
